...
try:
    ...
    print('--- Selecting 전체 Tab ---')
    try:
        # Find the '전체' tab. It's usually the first one.
        tab_link_xpath = "//ul[contains(@class, 'tab_list')]//a[span[text()='전체']]"
        ...
        print("Could not select 전체 tab for CU")
